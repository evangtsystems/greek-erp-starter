...
var createProductSchema = zod_1.z.object({
    organizationId: zod_1.z.string().uuid(),
    code: zod_1.z.string().min(1).nullable().optional(),
    name: zod_1.z.string().min(1),
    description: zod_1.z.string().min(1).nullable().optional(),
    unit: zod_1.z.string().min(1).default("piece"),
    unitPrice: zod_1.z.coerce.number().nonnegative(),
    vatRate: zod_1.z.coerce.number().min(0),
    active: zod_1.z.boolean().default(true)
});
exports.productRouter.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var parsed, product;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                parsed = createProductSchema.safeParse(req.body);
                if (!parsed.success) {
                    return [2 /*return*/, res.status(400).json({ error: parsed.error.flatten() })];
                }
                return [4 /*yield*/, client_js_1.prisma.product.create({
                        data: parsed.data
                    })];
            case 1:
                product = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, client_js_1.prisma.product.findMany({
